...
Research Experience
======
* Real-time comminication systems for online vision language model  
...
* Multi-party video conferencing (May 2025 - Aug 2025, with Prof. Francis)
  * Understood the challenges in auto-scaling selective forwarding unit (SFU) in cloud.
  * Prototyped a Jitsi based, regional traffic awared auto-scaling frameworks.
  * The vision for cloud-native autoscaling is made into an open-sourced engineering project at [Pion](https://github.com/pion/ion). 
...
* Cloud Management Systen Interaction (May 2024 - May 2025, with Prof. Tianyin)
  ...
  * Wrote static-analysis tool to uncover application-sepcific in cloud controller's custom resources.
...
* Cloud Storage System Emulator Fidelity (May 2023 - March 2024, with Prof. Tianyin) 
  ...
  * Built a testing framework that selectively run unit tests against cloud and emulator to ensure testing fidelity while minimizing the cost.
